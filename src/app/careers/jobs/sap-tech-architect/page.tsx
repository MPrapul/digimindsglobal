...
export const metadata: Metadata = {
  title: 'Technical Architect SAP ABAP - Red Hibbert Group',
  description: 'Join our team as a Technical Architect specializing in SAP ABAP. Help transform businesses through innovative SAP solutions.',
  keywords: ['SAP Technical Architect', 'SAP ABAP', 'SAP Jobs', 'Technical Architect Careers'],
}

export default function SAPTechArchitectPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 mb-8">
              <div className="prose max-w-none">
                ...
                <div className="mb-6">
                  <p className="text-gray-700">
                    <strong>Title:</strong> Technical Architect<br />
                    <strong>Type:</strong> Full-time job, 40 hours per week<br />
                    <strong>Salary:</strong> $206,315.00 per year<br />
                    <strong>Openings:</strong> 3<br />
                    <strong>Location:</strong> Red Hibbert Group LLC, 3001 Bishop Dr, Suite 300, San Ramon, CA 94583
                  </p>
                </div>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Job Duties</h2>
                <p className="text-gray-700 mb-6">
                  Participate in Business Workshops for gathering business requirements. Review Technical specification documents, coding, Unit Testing, Research. Analyze, design and develop computer software systems. Responsible for SAP business process analysis, business process re-engineering, systems implementation & customization of products using: SHANA, ABAP, ABAP OOPS, ODATA, CDS Views, EDI/DOCS, REST API, MM, SD, HR, PM & SAP PO. Analyze software requirements to determine feasibility of design within time and cost constraints. Provide training & technical support to users. Document and quality/code review of development for various SAP systems. Manage the overall execution of System Integration testing between multiple systems along with the testing team for SAP systems. Coordinate with the testing, infrastructure, and other vendor teams in terms of testing activities, during the testing phases. Facilitate the execution of User Acceptance testing activities. Coordinate with different stakeholders for execution and completion of different phases of Project. Act as an escalation point for any development issues & risks associated with Project delivery. Responsible for Delivery & solutioning of the SAP automated system with Quality checks. Travel And/or Relocation to Unanticipated Client Sites throughout USA is required.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Requirements</h2>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Education</h3>
                <p className="text-gray-700 mb-6">
                  Master&apos;s degree in Computer Science/Information Technology/Engineering (any) or closely related field with Six (6) months of experience in the job offered or as an IT Consultant or Analyst or Programmer or Developer or Software Engineer or closely related field. Employer also accepts Bachelor&apos;s degree in Computer Science/Information Technology/Engineering (any) or closely related field plus five years of progressive work experience in related field.
                </p>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">Experience</h3>
                <p className="text-gray-700 mb-6">
                  Experience of Six (6) months working with SAP ABAP is required. Travel and/or relocation is required to unanticipated client sites within USA. International travel is not required. The frequency of travel is currently not known as it depends on the client and project requirement that cannot be currently anticipated. Employer provides Information technology services to various clients in USA and hence implementing projects will require such travel.
                </p>
              ...
              <div className="mt-10">
                <a 
                  href="mailto:hr@redhibbert.com?subject=Application for Technical Architect SAP  Position&body=Dear Hiring Manager,%0D%0A%0D%0AI am writing to apply for the Technical Architect SAP  position at Red Hibbert Group.%0D%0A%0D%0A[Please include your experience, why you&apos;re interested, and attach your resume]%0D%0A%0D%0AThank you for considering my application.%0D%0A%0D%0ASincerely,%0D%0A[Your Name]"
