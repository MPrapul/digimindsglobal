...
export const metadata: Metadata = {
  title: 'Salesforce Business Analyst/Product Owner - Red Hibbert Group',
  description: 'Join our team as a Salesforce Business Analyst/Product Owner and help transform healthcare solutions with Salesforce Health Cloud.',
  keywords: ['Salesforce Business Analyst', 'Product Owner', 'Health Cloud', 'Salesforce Jobs', 'Healthcare IT'],
};

export default function SFBusinessAnalystPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 mb-8">
              <div className="prose max-w-none">
                ...
                <div className="mb-6">
                  <p className="text-gray-700">
                    <strong>Title:</strong> Salesforce Business Analyst/Product Owner<br />
                    <strong>Type:</strong> Full-time job, 40 hours per week<br />
                    <strong>Salary:</strong> $118,789.00 per year<br />
                ...
                <p className="text-gray-700 mb-6">
                  Implement Salesforce and support managing services engagements with a focus on Health Cloud vertical. Define the CRM product roadmap with SMEs and client stakeholders, deploying the solution to end users leveraging Salesforce Health Cloud Patient Services. Produce functional designs to drive product development, user experience, and system integrations. Facilitate initial discovery, define road map and MVP release plan for developing an AppExchange package and manage the evolving requirements backlog. Collaborate with Technical Architects and Designers to align business requirements with elegant and feasible design recommendations. Collaborate with Business Teams into building POCs showcasing Consent Data Management & Household Data Model. Work under supervision. Travel and/or relocation to unanticipated client sites throughout USA is required.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Requirements</h2>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Education</h3>
                <p className="text-gray-700 mb-6">
                  Bachelor&apos;s degree in Computer Science/IT/IS/Engineering (Any)/Business or closely related field with Twelve (12) months of experience in the job offered or as a Salesforce Business Analyst or IT Consultant or Analyst or Programmer or Developer or related field.
                </p>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">Experience</h3>
                <p className="text-gray-700 mb-6">
                  Experience of Twelve (12) months of working with Salesforce is required. Travel and/or relocation is required to unanticipated client sites within USA. International travel is not required. The frequency of travel is currently not known as it depends on the client and project requirement that cannot be currently anticipated. Employer provides Information technology services to various clients in USA and hence implementing projects will require such travel.
                  <br></br>
                  <br></br>
                </p>
              ...
              <div className="mt-10">
                <a 
                  href="mailto:hr@redhibbert.com?subject=Application for Salesforce Business Analyst/Product Owner Position&body=Dear Hiring Manager,%0D%0A%0D%0AI am writing to apply for the Salesforce Business Analyst/Product Owner position at Red Hibbert Group.%0D%0A%0D%0A[Please include your experience, why you&apos;re interested, and attach your resume]%0D%0A%0D%0AThank you for considering my application.%0D%0A%0D%0ASincerely,%0D%0A[Your Name]"
