      ...
      <section className="relative min-h-[700px] w-full overflow-hidden">
        ...
        <div className="container relative z-10 flex min-h-[700px] flex-col items-center justify-center text-center text-white mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <span className="text-sm text-white/80 mb-2 font-medium tracking-wider drop-shadow-lg">Scroll to explore</span>
              <motion.div 
                animate={{ y: [0, 10, 0] }}
                transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
                className="w-6 h-10 rounded-full border-2 border-white/40 flex justify-center pt-1 backdrop-blur-sm"
              >
                <motion.div 
                  animate={{ y: [0, 6, 0] }}
                  transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                >
                  <span className="text-[#0B5CAB] font-semibold">95% Client Satisfaction</span>
                </motion.div>
              </div>
            </motion.div>
          </div>
        ...
        >
          ...
          <div className="relative px-8 py-16 sm:px-16 sm:py-20">
            <div className="relative text-center text-white">
              ...
              >
                Let&apos;s discuss how our Salesforce solutions can transform your business and drive growth.
              </motion.p>
              <div className="flex justify-center">
                <motion.div
